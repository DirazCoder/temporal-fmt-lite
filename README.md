...
This is the lite version of [`temporal-fmt`](https://github.com/DirazCoder/temporal-fmt) — same two functions, same locales, ~52x smaller. It's meant to stay small. See [why](#why) below.
